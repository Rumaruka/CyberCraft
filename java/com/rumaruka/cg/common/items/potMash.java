...
public class potMash extends ItemFood {
	...
	public potMash(int p_i45339_1_, float p_i45339_2_, boolean p_i45339_3_) {
	...
	protected void onFoodEaten(ItemStack p_77849_1_, World p_77849_2_, EntityPlayer p_77849_3_) {
		if (!p_77849_2_.isRemote) {
			...
			p_77849_3_.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 500, 0));
