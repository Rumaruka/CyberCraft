...
public class TileEntityCoalGrinderIII extends TileEntity implements ISidedInventory{
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.field_145958_o : "container.Coal GrinderIII";
	}
	...
	public int getCookProgressScaled(int p_145953_1_) {
		return this.grindCookTime * p_145953_1_ / 85;
	}

	@SideOnly(Side.CLIENT)
	public int getBurnTimeRemainingScaled(int p_145955_1_) {
		if (this.currentItemBurnTime == 0) {
			this.currentItemBurnTime = 85;
		}
		...
		if (!this.worldObj.isRemote) {
			if (this.grindBurnTime != 0 || this.grindItemStacks[1] != null && this.grindItemStacks[0] != null) {
				...
				if (flag != this.grindBurnTime > 0) {
					flag1 = true;
					CoalGrinderIII.updateGrindBlockState(this.grindBurnTime > 0, this.worldObj, this.xCoord, this.yCoord,
							this.zCoord);
				}
			}
	...
	private boolean canGrind() {
		if (this.grindItemStacks[0] == null) {
			...
			ItemStack itemstack = GrindOnlyForIIITier.grinding().getSmeltingResult(this.grindItemStacks[0]);
			if (itemstack == null)
				return false;
